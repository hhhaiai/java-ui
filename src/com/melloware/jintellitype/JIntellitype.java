...
public final class JIntellitype implements JIntellitypeConstants {
   ...
   private static String systemBit = "64";

   public static void setSystemBit(String systemBit) {
	   JIntellitype.systemBit = systemBit;
   }
   ...
   private JIntellitype() {
	  String JIntellitypeFileName = null;
      try {
    	 JIntellitypeFileName = "JIntellitype" + systemBit;
         // Load JNI library
         System.loadLibrary(JIntellitypeFileName);
         ...
         try {
            if (getLibraryLocation() != null) {
               ...
               try {
                  String dll = JIntellitypeFileName + ".dll";
