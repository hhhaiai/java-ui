...
public class Lang {
     ...
     * @param message
     *            要显示的信息
     * @return int {@link Lang#CONFIRM_YES} {@link Lang#CONFIRM_NO}
     *         {@link Lang#CONFIRM_CENCEL}
    ...
    public static String time() {
        ...
        String xnx3_time = time_triansform(YY) + "-" + time_triansform(MM) + "-" + time_triansform(DD) + " "
                + time_triansform(HH) + ":" + time_triansform(mm) + ":" + time_triansform(SS);
     ...
     * 
     * @param text
     *            如: xnx3.jar 或者 /Users/apple/xnx3.jar
     ...
     * @return 成功或失败
     */
    public static boolean listAppend(List<CoordBean> list, List<CoordBean> appendList) {
        if (appendList == null) {
            return true;
        }
